...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { geolocation: @point.geolocation, location: @point.location, route_id: @point.route_id }
    end
  ...
  test "should update point" do
    put :update, id: @point, point: { geolocation: @point.geolocation, location: @point.location, route_id: @point.route_id }
    assert_redirected_to point_path(assigns(:point))
  end
